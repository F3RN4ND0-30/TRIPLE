...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="card-grid">
            <a href="silif/frontend/sisvis/escritorio.php" class="card card-licencia">
                <h2>Licencia de Funcionamiento</h2>
                <p>Gestión y revisión de licencias emitidas.</p>
            </a>

            <a href="mpartes/frontend/sisvis/escritorio.php" class="card card-mesa">
                <h2>Mesa de Partes</h2>
                <p>Ingreso, seguimiento y asignación de expedientes.</p>
            </a>

            <a href="sinadeci/frontend/sisvis/escritorio.php" class="card card-defensa">
                <h2>Defensa Civil</h2>
