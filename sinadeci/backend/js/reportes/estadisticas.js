...
function getRowData(tr) {
  ...
  return {
    ...
    razon:     (tr.querySelector(".company-name")?.textContent ?? tr.querySelector(".razon")?.textContent ?? "").trim(),
...
document.addEventListener("click", (e) => {
  ...
  if (e.target.closest(".accion-card")) {
    ...
    const data = tr ? getRowData(tr) : { id, razon: "", ruc: "", emision: "", direccion: "", area: "", aforo: "" };
