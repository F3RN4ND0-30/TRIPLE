...
<head>
  ...
  <title>SINADECI — Reporte de Certificaciones</title>
  ...
  <!-- Estilos de módulo -->
  <link rel="stylesheet" href="../../backend/css/reportes/rep_certificaciones.css" />
      ...
      <section class="hero-section">
        <div class="hero-content">
          <div class="hero-info">
            ...
            <div class="hero-text">
              <h1 class="hero-title">Reporte de Certificaciones</h1>
              <p class="hero-subtitle">Generar reporte de certificaciones emitidas</p>
            </div>
          </div>
      ...
      <section class="listado-section">
        <div class="listado-header">
          <div class="listado-title">
            ...
            <h5 class="mb-0">Reporte de Certificaciones</h5>
          </div>
