...
$personas = [
  ["id" => "000066", "fecha" => "22/09/2025","dni" => "71532918", "nombre" => "JOSE LUIS PEÑA GONZALES", "ruc" => "20498189637"],
  ["id" => "000065", "fecha" => "22/09/2025","dni" => "22309032", "nombre" => "JOSE LUIS PEÑA GONZALES","ruc" => "20104624104"],
  ["id" => "000294", "fecha" => "22/09/2025","dni" => "40015871", "nombre" => "JOSE LUIS PEÑA GONZALES","ruc" => "10702036939"],
  ["id" => "000293", "fecha" => "22/09/2025","dni" => "41132323","nombre" => "JOSE LUIS PEÑA GONZALES", "ruc" => "10222917986"],
  ["id" => "000292", "fecha" => "22/09/2025","dni" => "41232548", "nombre" => "JOSE LUIS PEÑA GONZALES","ruc" => "10412778044"],
];
?>
...
<head>
  ...
  <!-- Estilos de módulo -->
  <link rel="stylesheet" href="../../backend/css/administrado/personas.css" />
  <link rel="icon" type="image/png" href="../../backend/img/ICONO-SINADECI.ico" />

  <!-- Libs -->
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

  <meta name="description" content="Gestión de personas registradas" />
</head>
...
<body class="dashboard-body">
  ...
  <main class="main-container">
    <div class="content-wrapper">
      ...
      <section class="hero-section">
        <div class="hero-content">
          <div class="hero-info">
            ...
            <div class="hero-text">
              <h1 class="hero-title">Personas</h1>
              <p class="hero-subtitle">Listado de personas registradas</p>
            </div>
          </div>
      ...
      <section class="listado-section">
                ...
                <tbody>
                  <?php foreach ($personas as $c): ?>
                    <tr class="table-row" data-id="<?= $c['id'] ?>">
                      ...
                      <td>
                        <span class="date-badge"><?= $c['fecha'] ?></span>
                      </td>
                      <td>
                        <span class="date-badge"><?= $c['dni'] ?></span>
                      </td>
                      <td>
                        <span class="ruc-text"><?= $c['nombre'] ?></span>
                      </td>
                      <td class="text-end">
                        <span class="metric-value"><?= $c['ruc'] ?></span>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              ...
              <?php foreach ($personas as $c): ?>
                <div class="cert-card" data-id="<?= $c['id'] ?>">
                  ...
                  <div class="cert-card-body">
                    <h6 class="company-name" title="<?= htmlspecialchars($c['nombre']) ?>">
                      <?= htmlspecialchars($c['nombre']) ?>
                    </h6>
                    <p class="company-address" title="<?= htmlspecialchars($c['ruc']) ?>">
                      <i class="fas fa-user me-1"></i>
                      <?= htmlspecialchars($c['ruc']) ?>
                    </p>
        ...
        <div class="listado-footer">
          <div class="pagination-info">
            Mostrando <strong>1-<?= count($personas) ?></strong> de <strong><?= count($personas) ?></strong> resultados
          </div>
      ...
      <!-- FAB: Nueva persona -->
      <button class="fab-button" id="fabNueva" title="Nueva persona (Ctrl+N)">
        <i class="fas fa-plus"></i>
        <span class="fab-tooltip">Nueva Persona</span>
      </button>
    </div>
  </main>
  ...
  <script src="../../backend/js/administrado/personas.js"></script>
</body>
