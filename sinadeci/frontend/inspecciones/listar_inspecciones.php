...
<head>
    ...
    <title>SINADECI — INSPECCIONES</title>
    ...
    <!-- Estilos de módulo -->
    <link rel="stylesheet" href="../../backend/css/inspecciones/inspecciones.css" />
...
<body class="dashboard-body">
    ...
    <main class="main-container">
        <div class="content-wrapper">
            ...
            <section class="hero-section">
                <div class="hero-content">
                    <div class="hero-info">
                        ...
                        <div class="hero-text">
                            <h1 class="hero-title">Inspecciones</h1>
                            <p class="hero-subtitle">Listado de las inspecciones realizadas</p>
                        </div>
                    </div>
            ...
            <section class="listado-section">
                <div class="listado-header">
                    <div class="listado-title">
                        ...
                        <h5 class="mb-0">Listado de Inspecciones</h5>
                    </div>
                    <div class="listado-stats">
                        <span class="stats-badge">
                            <i class="fas fa-file-alt me-1"></i>
                            <?= count($inspecciones) ?> inspecciones
                        </span>
                        <span class="stats-badge">
                ...
                <div class="listado-footer">
                    <div class="pagination-info">
                        Mostrando <strong>1-<?= count($inspecciones) ?></strong> de <strong><?= count($inspecciones) ?></strong> resultados
                    </div>
            ...
            <button class="fab-button" id="fabNueva" title="Nueva Inspección (Ctrl+N)">
                <i class="fas fa-plus"></i>
                <span class="fab-tooltip">Nueva Inspección</span>
            </button>
        </div>
    </main>
            ...
            <form class="modal-content modern-modal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-text">Adjunta el documento del Inspección en formato PDF</div>
                    </div>
